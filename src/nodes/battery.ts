...
import { checkEnumValue, ColourMode, CssClass, DeviceClasses, DevicesLayout, DisplayMode, ELECTRIC_ENTITY_CLASSES, EnergyDirection, SIUnitPrefixes } from "@/enums";
...
export class BatteryNode extends Node<BatteryConfig> {
  ...
  public orientation: DevicesLayout = DevicesLayout.None;
