...
In the below options, `import` is energy produced by the device; `export` is energy consumed by the device.

In `power` mode, bi-directional entities must return positive values for production and negative values for consumption. Uni-directional entities should only return positive values.
...
| Name                  | Type                                         | Default | Description                                                                   |
|-----------------------|----------------------------------------------|---------|-------------------------------------------------------------------------------|
| `flow_import_colour`  | `number[]`                                   |         | An RGB triplet of the colour to use                                           |
| `flow_export_colour`  | `number[]`                                   |         | An RGB triplet of the colour to use                                           |
